...
(function() {
  module.exports = function(state, element, size) {
    var cell, i, str, substate, _i, _j, _len, _len1, _results;
    element.html('');
    if (state[0].path) {
      _results = [];
    ...
    if (cellsToToggle.length === 0) {
      ...
      nestedMap = function(dimension) {
        if (!dimension[0].path) {
          ...
          return dimension.map(function(cell) {
            if (cell.isAlive) {
...
(function(){(function() {
  ...
  $(document).ready(function() {
    var generatedState, i, interval, set, specimen, _i, _set;
    set = [];
...
},{"../bower_components/jquery/dist/jquery.js":6,"./input.coffee":4,"./output.coffee":1,"./process.coffee":2}],6:[function(require,module,exports){
(function(){/*!
